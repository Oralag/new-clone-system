<template>
  <div class="dept-bulletin">
    <div class="dept-bulletin-hd">
      <svg width="12" height="12" viewBox="0 0 12 12" fill="none" stroke="currentColor" stroke-width="1.3" stroke-linecap="round"><rect x="1" y="2" width="10" height="8" rx="1.5"/><path d="M3.5 5h5M3.5 7.5h3"/></svg>
      <span>工作任务</span>
    ...
    <div v-else class="dept-bulletin-body">
      ...
      <span v-else class="dept-bulletin-empty">暂无工作任务</span>
    </div>
  </div>
</template>
