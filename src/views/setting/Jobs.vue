<template>
  <div class="page-container">
    <el-card>
      <ScTable ref="tableRef" :api-obj="getJobsList" :params="searchForm">
        <template #search>
          <el-form inline>
        ...
        <el-table-column prop="name" label="职务名称" min-width="140" />
    ...
    <ScForm ref="formRef" :title="formTitle" @submit="handleSubmit">
      <template #default="{ form }">
        <el-form-item label="职务名称" :rules="[{ required: true, message: '请输入职务名称' }]" prop="name">
...
async function handleDelete(id: number) {
  await ElMessageBox.confirm('确定删除该职务？', '提示', { type: 'warning' })
  await deleteJobs(id)
