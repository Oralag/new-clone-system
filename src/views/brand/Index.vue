...
@media (max-width: 600px) { .brand-mode-grid { grid-template-columns: repeat(2, minmax(0, 1fr)); flex: 1; min-height: 0; width: 100%; } }
@media (max-width: 768px) {
  ...
  .brand-mode-grid { grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 10px; border-radius: 14px; max-width: none; flex: 1; min-height: 0; width: 100%; align-content: center; }
...
@media (max-width: 768px) {
  ...
  .brand-product-grid { grid-template-columns: 1fr 1fr; }
  .brand-mode-grid { grid-template-columns: repeat(2, minmax(0, 1fr)); flex: 1; min-height: 0; width: 100%; align-content: center; }
