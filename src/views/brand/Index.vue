...
@media (max-width: 600px) { .brand-mode-grid { grid-template-columns: 1fr 1fr; grid-template-rows: 1fr 1fr; height: 100%; } }
@media (max-width: 768px) {
  .brand-mode-overlay { inset: calc(44px + env(safe-area-inset-top, 0px)) 0 calc(50px + env(safe-area-inset-bottom, 0px)) 0; padding: 12px; }
  .brand-mode-grid { grid-template-columns: 1fr 1fr; grid-template-rows: 1fr 1fr; gap: 10px; border-radius: 14px; max-width: none; height: 100%; }
...
@media (max-width: 768px) {
  ...
  .brand-product-grid { grid-template-columns: 1fr 1fr; }
  .brand-mode-grid { grid-template-columns: 1fr 1fr; grid-template-rows: 1fr 1fr; height: 100%; }
