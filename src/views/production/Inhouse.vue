<template>
  <div class="page-container">
    <el-card>
      <ScTable ref="tableRef" :api-obj="getProductionInhouseList" :params="searchForm">
        <template #search>
          <el-form inline>
...
import { getProductionInhouseList, createProductionInhouse, deleteProductionInhouse } from '@/api/production'

const tableRef = ref<InstanceType<typeof ScTable>>()
const formRef = ref<InstanceType<typeof ScForm>>()
const formTitle = ref('新增生产入库')
...
async function handleSubmit(data: any) {
  ...
  try {
    await createProductionInhouse(data)
