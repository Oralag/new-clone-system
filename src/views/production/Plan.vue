<template>
  <div class="page-container">
    <el-card>
      <ScTable ref="tableRef" :api-obj="getProductionPlanList" :params="searchForm">
        <template #search>
          <el-form inline>
        ...
        <el-table-column prop="actual_num" label="实际数量" width="110" />
...
import { getProductionPlanList, createProductionPlan, deleteProductionPlan } from '@/api/production'

const tableRef = ref<InstanceType<typeof ScTable>>()
const formRef = ref<InstanceType<typeof ScForm>>()
const formTitle = ref('新增生产计划')
...
function openForm(row?: any) {
  formTitle.value = row ? '编辑生产计划' : '新增生产计划'
