<template>
  <div class="plan-page">
    ...
    <div v-if="!showForm">
      <el-card>
        <ScTable ref="tableRef" :api-obj="getProcurePlanList" :params="searchForm">
          <template #search>
    ...
    <div v-else class="form-page">
      ...
      <div class="form-topbar">
        <div style="display:flex;align-items:center;gap:12px">
          ...
          <span class="form-title">{{ fd.id ? '编辑采购计划' : '新增采购计划' }}</span>
        </div>
...
import { getProcurePlanList, createProcurePlan, deleteProcurePlan, getSupplierList, createSupplier } from '@/api/procure'
...
const searchForm = reactive<any>({ plan_no: '', supplier_name: '', status: '' })
