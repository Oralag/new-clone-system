  ...
  <div class="page-container">
    <el-card>
      <ScTable ref="tableRef" :api-obj="getTransferList"
        ...
        <el-table-column prop="transfer_no" label="调拨单编号" width="160" />
        <el-table-column prop="goods_name" label="商品名称" min-width="150" />
        <el-table-column prop="num" label="数量" width="100" />
        <el-table-column prop="from_warehouse" label="调出仓库" width="150" />
        <el-table-column prop="to_warehouse" label="调入仓库" width="150" />
    ...
    <ScForm ref="formRef" title="新增调拨单" @submit="handleSubmit">
      <template #default="{ form }">
        ...
        <el-form-item label="调出仓库" prop="from_warehouse">
          <el-input v-model="form.from_warehouse" placeholder="请输入调出仓库" />
        </el-form-item>
        <el-form-item label="调入仓库" prop="to_warehouse">
          <el-input v-model="form.to_warehouse" placeholder="请输入调入仓库" />
        </el-form-item>
...
import { getTransferList, createTransfer, deleteTransfer } from '@/api/warehouse'
