<template>
  <div class="page-container">
    <el-card>
      <ScTable ref="tableRef" :api-obj="getCheckList" :params="searchForm">
        <template #search>
          <el-input v-model="searchForm.check_no" placeholder="盘点单编号" clearable style="width: 180px" />
        ...
        <el-table-column prop="check_no" label="盘点单编号" width="160" />
    ...
    <ScForm ref="formRef" title="新增盘点单" @submit="handleSubmit">
      <template #default="{ form }">
        <el-form-item label="仓库名称" prop="warehouse_name" :rules="[{ required: true, message: '请输入仓库名称' }]">
