<template>
  <div class="page-container">
    <el-card>
      <ScTable ref="tableRef" :api-obj="getBatchList" :params="searchForm">
        <template #search>
        ...
        <el-table-column prop="produce_date" label="生产日期" width="130" />
        <el-table-column prop="expire_date" label="过期日期" width="130" />
