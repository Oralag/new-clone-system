<template>
  <div class="page-container">
    ...
    <el-dialog v-model="dialogVisible" title="新增请假申请" width="500px" @closed="onDialogClosed">
      <el-form ref="formRef" :model="form" :rules="rules" label-width="90px">
        <el-form-item label="假期类型">
          <el-select v-model="form.leave_type" placeholder="请选择假期类型" style="width:100%">
...
import { getLeaveList, createLeave, deleteLeave } from '@/api/office'
...
function onDialogClosed() {
  ...
  Object.assign(form, { leave_type: '', start_date: '', end_date: '', remark: '' })
}
</script>
